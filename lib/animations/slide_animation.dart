...
class SlideAnimation extends StatefulWidget {
  const SlideAnimation(
      {required this.child, required this.slideDirection, super.key});
  final Widget child;
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.slideDirection) {
      ...
      case SlideDirection.leftAway:
        tween = Tween<Offset>(begin: const Offset(0, 0), end: const Offset(-1.4, 0));
        break;
      case SlideDirection.rightAway:
        tween = Tween<Offset>(begin: const Offset(0, 0), end: const Offset(1.4, 0));
        break;
      case SlideDirection.leftIn:
        tween = Tween<Offset>(begin: const Offset(-1.4, 0), end: const Offset(0, 0));
        break;
      case SlideDirection.rightIn:
        tween = Tween<Offset>(begin: const Offset(1.4, 0), end: const Offset(0, 0));
        break;
      case SlideDirection.upIn:
        tween = Tween<Offset>(begin: const Offset(0, 1.4), end: const Offset(0, 0));
        break;
